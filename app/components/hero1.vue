...
<template>
  <div
    class="flex w-full py-10 md:py-20 md:pl-15 px-4 flex-col md:flex-row gap-y-4"
  >
    <div class="w-full md:w-1/2 flex flex-col">
      <div class="h-14 hidden md:block" />
      <img
        src="../assets/images/5-DUAVRrOA.png"
        alt=""
    ...
    >
      ...
      <p class="text-lg text-gray-500">
        ...
        platforms. From mobile banking to instant transfers, we're making
        business banking more accessible than ever.
      </p>
    </div>
  </div>
